...
class AlarmOverrideSetSerde:
    ...
    def to_dict(obj):
        ...
        return {
            ...
            "ondelay": {"expiration": obj.ondelay.expiration} if obj.ondelay is not None else None,
            "offdelay": {"expiration": obj.offdelay.expiration} if obj.offdelay is not None else None,
